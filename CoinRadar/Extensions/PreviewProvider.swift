...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$1.23T", percentageChange: 25.34)
    let stat2 = StatisticModel(title: "Total Volume", value: "$1.23T")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$50.4T", percentageChange: -12.34)
